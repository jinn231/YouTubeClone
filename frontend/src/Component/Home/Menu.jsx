        ...
        <>
            <div className='border-b pb-4' >
                <ul>
                    <li>
                        <Link to="/">
                            <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                                <svg className='w-10 h-7' viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g ><path d="M4,10V21h6V15h4v6h6V10L12,3Z"></path></g></svg>
                                <p className='pt-1 font-robo'>Home</p>
                            </button>
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link to="/sub">
                            <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                                <svg className='w-10 h-7' viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g><path d="M10,18v-6l5,3L10,18z M17,3H7v1h10V3z M20,6H4v1h16V6z M22,9H2v12h20V9z M3,10h18v10H3V10z"></path></g></svg>
                                <p className='pt-1 font-robo'>Subscriptions</p>
                            </button> 
                        </Link>
                    </li>
                </ul>
            ...
            <div className='border-b pb-4'>
                <ul>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g><path d="M11,7l6,3.5L11,14V7L11,7z M18,20H4V6H3v15h15V20z M21,18H6V3h15V18z M7,17h13V4H7V17z"></path></g></svg>                            <p className='pt-1 font-robo'>Library</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g><path d="M14.97,16.95L10,13.87V7h2v5.76l4.03,2.49L14.97,16.95z M22,12c0,5.51-4.49,10-10,10S2,17.51,2,12h1c0,4.96,4.04,9,9,9 s9-4.04,9-9s-4.04-9-9-9C8.81,3,5.92,4.64,4.28,7.38C4.17,7.56,4.06,7.75,3.97,7.94C3.96,7.96,3.95,7.98,3.94,8H8v1H1.96V3h1v4.74 C3,7.65,3.03,7.57,3.07,7.49C3.18,7.27,3.3,7.07,3.42,6.86C5.22,3.86,8.51,2,12,2C17.51,2,22,6.49,22,12z"></path></g></svg>
                            <p className='pt-1 font-robo'>History</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g><path d="M10,8l6,4l-6,4V8L10,8z M21,3v18H3V3H21z M20,4H4v16h16V4z"></path></g></svg>                            <p className='pt-1 font-robo'>Your videos</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g><path d="M14.97,16.95L10,13.87V7h2v5.76l4.03,2.49L14.97,16.95z M12,3c-4.96,0-9,4.04-9,9s4.04,9,9,9s9-4.04,9-9S16.96,3,12,3 M12,2c5.52,0,10,4.48,10,10s-4.48,10-10,10S2,17.52,2,12S6.48,2,12,2L12,2z"></path></g></svg>                            <p className='pt-1 font-robo'>Watch Later</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g><path d="M18.77,11h-4.23l1.52-4.94C16.38,5.03,15.54,4,14.38,4c-0.58,0-1.14,0.24-1.52,0.65L7,11H3v10h4h1h9.43 c1.06,0,1.98-0.67,2.19-1.61l1.34-6C21.23,12.15,20.18,11,18.77,11z M7,20H4v-8h3V20z M19.98,13.17l-1.34,6 C18.54,19.65,18.03,20,17.43,20H8v-8.61l5.6-6.06C13.79,5.12,14.08,5,14.38,5c0.26,0,0.5,0.11,0.63,0.3 c0.07,0.1,0.15,0.26,0.09,0.47l-1.52,4.94L13.18,12h1.35h4.23c0.41,0,0.8,0.17,1.03,0.46C19.92,12.61,20.05,12.86,19.98,13.17z"></path></g></svg>                            <p className='pt-1 font-robo'>Liked Videos</p>
                        </button>
                    </li>
                    <button className="flex gap-5 p-2 hover:bg-gray-100 rounded-lg w-full">
                        <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M12,15.7L5.6,9.4l0.7-0.7l5.6,5.6l5.6-5.6l0.7,0.7L12,15.7z"></path></g></svg>
                        <p className='pt-1 font-robo'>Show More</p>
                    </button>
                </ul>
            </div>
            ...
            <div className='border-b pb-4'>
                <ul>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                        <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g ><path d="M12,9c1.65,0,3,1.35,3,3s-1.35,3-3,3s-3-1.35-3-3S10.35,9,12,9 M12,8c-2.21,0-4,1.79-4,4s1.79,4,4,4s4-1.79,4-4 S14.21,8,12,8L12,8z M13.22,3l0.55,2.2l0.13,0.51l0.5,0.18c0.61,0.23,1.19,0.56,1.72,0.98l0.4,0.32l0.5-0.14l2.17-0.62l1.22,2.11 l-1.63,1.59l-0.37,0.36l0.08,0.51c0.05,0.32,0.08,0.64,0.08,0.98s-0.03,0.66-0.08,0.98l-0.08,0.51l0.37,0.36l1.63,1.59l-1.22,2.11 l-2.17-0.62l-0.5-0.14l-0.4,0.32c-0.53,0.43-1.11,0.76-1.72,0.98l-0.5,0.18l-0.13,0.51L13.22,21h-2.44l-0.55-2.2l-0.13-0.51 l-0.5-0.18C9,17.88,8.42,17.55,7.88,17.12l-0.4-0.32l-0.5,0.14l-2.17,0.62L3.6,15.44l1.63-1.59l0.37-0.36l-0.08-0.51 C5.47,12.66,5.44,12.33,5.44,12s0.03-0.66,0.08-0.98l0.08-0.51l-0.37-0.36L3.6,8.56l1.22-2.11l2.17,0.62l0.5,0.14l0.4-0.32 C8.42,6.45,9,6.12,9.61,5.9l0.5-0.18l0.13-0.51L10.78,3H13.22 M14,2h-4L9.26,4.96c-0.73,0.27-1.4,0.66-2,1.14L4.34,5.27l-2,3.46 l2.19,2.13C4.47,11.23,4.44,11.61,4.44,12s0.03,0.77,0.09,1.14l-2.19,2.13l2,3.46l2.92-0.83c0.6,0.48,1.27,0.87,2,1.14L10,22h4 l0.74-2.96c0.73-0.27,1.4-0.66,2-1.14l2.92,0.83l2-3.46l-2.19-2.13c0.06-0.37,0.09-0.75,0.09-1.14s-0.03-0.77-0.09-1.14l2.19-2.13 l-2-3.46L16.74,6.1c-0.6-0.48-1.27-0.87-2-1.14L14,2L14,2z" ></path></g></svg>                           
                        <p className='pt-1 font-robo'>Setting</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                        <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g ><path d="M13.18,4l0.24,1.2L13.58,6h0.82H19v7h-5.18l-0.24-1.2L13.42,11H12.6H6V4H13.18 M14,3H5v18h1v-9h6.6l0.4,2h7V5h-5.6L14,3 L14,3z" ></path></g></svg>                          
                        <p className='pt-1 font-robo'>Report history</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g ><path d="M13,14h-2v-2h2V14z M13,5h-2v6h2V5z M19,3H5v16.59l3.29-3.29L8.59,16H9h10V3 M20,2v15H9l-5,5V2H20L20,2z" ></path></g></svg>                            <p className='pt-1 font-robo'>Help</p>
                        </button>
                    </li>
                    <li>
                        <button className='flex gap-5 w-full p-2 hover:bg-gray-100 rounded-lg'>
                            <svg className="w-10 h-7" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g ><path d="M15.36,9.96c0,1.09-0.67,1.67-1.31,2.24c-0.53,0.47-1.03,0.9-1.16,1.6L12.85,14h-1.75l0.03-0.28 c0.14-1.17,0.8-1.76,1.47-2.27c0.52-0.4,1.01-0.77,1.01-1.49c0-0.51-0.23-0.97-0.63-1.29c-0.4-0.31-0.92-0.42-1.42-0.29 c-0.59,0.15-1.05,0.67-1.19,1.34L10.32,10H8.57l0.06-0.42c0.2-1.4,1.15-2.53,2.42-2.87c1.05-0.29,2.14-0.08,2.98,0.57 C14.88,7.92,15.36,8.9,15.36,9.96z M12,18c0.55,0,1-0.45,1-1s-0.45-1-1-1s-1,0.45-1,1S11.45,18,12,18z M12,3c-4.96,0-9,4.04-9,9 s4.04,9,9,9s9-4.04,9-9S16.96,3,12,3 M12,2c5.52,0,10,4.48,10,10s-4.48,10-10,10S2,17.52,2,12S6.48,2,12,2L12,2z" ></path></g></svg>                            
                            <p className='pt-1 font-robo'>Send feeback</p>
                        </button>
                    </li>                    
                </ul>
            </div>
            ...
            <div className='border-b pb-20 p-3'>
                ...
                <div className="flex flex-wrap my-5">
                    ...
                    <p className="text-sm font-robo px-2">How YouTube works</p>
                    <p className="text-sm font-robo px-2">Test</p>
                    <p className="text-sm font-robo px-2">new feature</p>
                </div>
